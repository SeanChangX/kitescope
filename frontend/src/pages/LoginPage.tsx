      ...
      {loading ? (
        ...
        <div className="flex flex-col items-center gap-4">
          {lineUrl ? (
            <a
              href={lineUrl}
              className="flex min-h-[42px] w-[280px] max-w-full items-center justify-center gap-2 rounded-lg bg-[#06C755] px-4 text-base font-semibold text-white hover:bg-[#05b34a]"
            >
          ...
          {telegramBot ? (
            <div
              ...
              className="flex min-h-[42px] w-[280px] max-w-full items-center justify-center"
            />
          ) : (
